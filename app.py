...
if out:
    with tab_plan:
        ...
        if not plan_obj:
            ...
            plan_dict = plan_obj.model_dump() if hasattr(plan_obj, "model_dump") else (plan_obj if isinstance(plan_obj, dict) else json.loads(json.dumps(plan_obj, default=str)))
